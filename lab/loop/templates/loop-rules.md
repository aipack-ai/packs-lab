...
When you want to request a follow‑up run with a new prompt to continue the, include a NEXT_PROMPT tag containing the new prompt content as described below.
